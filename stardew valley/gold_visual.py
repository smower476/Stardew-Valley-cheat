...
gameModule = module_from_name(pm.process_handle, "System.Private.Xml.dll").lpBaseOfDll
...
tmp = GetPtrAddr(gameModule + 0x00022D48, [0x0, 0x20, 0x60, 0x88, 0xC0, 0x60, 0x1C])
print(hex(tmp))
